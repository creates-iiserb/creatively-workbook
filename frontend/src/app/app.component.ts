...
export class AppComponent implements OnInit {
    ...
    constructor( private renderer : Renderer, private router: Router, private element : ElementRef, 
        public location: Location, private tds: TempdataService, private gbl: Global,private dataServer : BackendService,
        private cs :CommonService, private language: Language) {

            this.tds.getAppMetaData();
            // this.tds.language = this.language.language.default;

            //Get User details (like isbetauser, wbList(subscribed by user))
